...
from init import params, str_params
import utils
...
model = NeuralAMP_AutoEncoder(params['N_bs'], params['K'], params['T'], device='cuda')
...
torch.save(model.state_dict(), '{}.pkl'.format(starttime))
